...
namespace iPath.Database.Sqlite.Migrations
{
    ...
    [Migration("20260123093941_Questionnaire_BodySiteFilter")]
    partial class Questionnaire_BodySiteFilter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("iPath.Domain.Entities.QuestionnaireEntity", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "BodySiteFilter", "iPath.Domain.Entities.QuestionnaireEntity.BodySiteFilter#ConceptFilter", b1 =>
                        {
                            b1.Property<string>("CodeSystem")
                                .IsRequired();

                            b1.PrimitiveCollection<string>("Codes")
                                .IsRequired();
