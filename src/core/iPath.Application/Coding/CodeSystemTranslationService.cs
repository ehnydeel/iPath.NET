...
public class CodeSystemTranslationService(ILogger<CodeSystemTranslationService> logger)
{
    ...
    private readonly Dictionary<string, ValueSetTranslationService> _valueSet = new();
    ...
    public string DefaultCodeSystemId { get; set; }
    ...
    public void LoadValueSet(ValueSet vs, string? vsId = null)
    {
        ...
        var provider = new ValueSetTranslationService(this, _codeSystems[vsSystemUrl], vs);
    ...
    public ValueSetTranslationService? GetValueSet(string vsId)
    {
